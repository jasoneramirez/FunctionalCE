...
def optimizacion(ind,n_curvas,modelo_opt,leaves, values, restricciones_right, restricciones_left, x,J, y, y_pred,model,datos_arbol):
    ...
    #    for n in instance.tsolo:
    #        print(instance.N.value)
    #        print(instance.J.value)
    #        print([n,j,n+j*instance.N.value/instance.J.value])

    #instance.counterfs.pprint()
